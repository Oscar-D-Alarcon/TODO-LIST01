...
class TodoAddEdit : AppCompatActivity() {
    ...
    fun formSetUpAdd(){
        ...
        vTodoBtnSave.setOnClickListener {
            ...
            todoDBController!!.insert (TodoItemData(0, vTodoInputTitle.text.toString(), vTodoInputMessage.text.toString(), vTodoInputDate.text.toString(), vTodoInputImage.text.toString()))
